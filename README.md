# Yimin_Dochub
This branch provides the experiment records of conducting various pick-and-place tasks on a UR10e robot at wbk ct-cell. 

For experiment videos and point clouds check out the [``Resources/experiments/``](https://github.com/SFB-Circular-Factory-WG-C/Yimin_Dochub/tree/media/Resources/experiments) folder.
